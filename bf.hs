...
-- Ordering to sort by frequency in main
...
-- This section contains parsers that search for optimizable sequences
...
-- This section contains the string representation of the instructions
loop :: Int -> String
...
-- Zips Two Code trees together W(reill throw an exception if the structures of the tree don't match)
